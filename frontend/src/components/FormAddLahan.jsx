...
const FormAddLahan = () => {
  ...
  const saveLahan = async (e) => {
    e.preventDefault();
    try {
      await axiosInstance.post("/lahan", {
        name: name,
        alamat: alamat,
        luas: luas,
      });
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <div className="mb-8">
        ...
        <h2 className="text-xl font-bold">Add New Lahan</h2>
      </div>
      ...
      <form onSubmit={saveLahan} className="space-y-6">
